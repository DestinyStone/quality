...
public class DiApproveUtils {
	...
	public static List<ProcessContainer> getUnReportProcessTaskList(String busId) {
		...
		userCommit.setServerFlag(ApproveUtils.ServerFlagEnum.DI_APPROVE.getMessage());
		...
		downLoadResourceApprove.setServerFlag(ApproveUtils.ServerFlagEnum.DI_APPROVE.getMessage());
	...
	public static List<ProcessContainer> getProcessTaskList(String busId) {
		...
		bossProcess.setServerFlag(ApproveUtils.ServerFlagEnum.DI_APPROVE.getMessage());
